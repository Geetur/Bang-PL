...
def test_single_char_operators():
    code = "+ - * / = ! ( ) { } [ ] ,"
    expected = [
        TokenType.T_PLUS, TokenType.T_MINUS, TokenType.T_ASTERISK, TokenType.T_SLASH,
        TokenType.T_ASSIGN, TokenType.T_NEGATE,
        TokenType.T_LPAREN, TokenType.T_RPAREN, TokenType.T_LBRACE, TokenType.T_RBRACE,
        TokenType.T_LBRACKET, TokenType.T_RBRACKET, TokenType.T_COMMA
    ]
